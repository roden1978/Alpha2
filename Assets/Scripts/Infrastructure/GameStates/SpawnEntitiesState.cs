...
namespace Infrastructure.GameStates
{
    public class SpawnEntitiesState : IState
    {
        ...
        private List<PickableObjectMarker> _pickableObjectMarkers;
        ...
        private void FindAllMarkersInScene()
        {
            ...
            _pickableObjectMarkers = Object.FindObjectsOfType<PickableObjectMarker>().ToList();
        ...
        {
            foreach (PickableObjectMarker marker in _pickableObjectMarkers)
            {
                Object.Destroy(marker.gameObject);
            }
        }
